...
//   return (
//     <div className="fixed top-0 right-0 left-0 z-50 flex jutify-center items-center w-full h-[calc(100%-1rem)] max-h-full overdlow-y-auto overflow-x-hidden bg-black/20 bg-opacity-50">
//       <div className="relative p-4 w-full max-w-2xl max-h-full">
//         {/*Modal content */}
//         <div className="bg-white rounded-lg shawdow-sm dark:bg-gray-700">
//           {/*Modal header*/}
//           <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600 border-gray-200">
//             <h3 className="text-lg font-medium text-grey-900 dark:text-white">
//               {title}
//             </h3>
