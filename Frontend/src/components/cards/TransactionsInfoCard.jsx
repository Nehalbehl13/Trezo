...
//       <div className="w-12 h-12 flex-center justify-center text-xl text-gray-800 bg-gray-100 rounded-full">
//         {icon ? (
...
//                 {!hideDeletionBtn && (
//                     <button className="text-gray-400 hover:text-red-500 opacity-0 group-hover:opacity-100 transitions-opacity cursor-points"
//                     onClick={onDelete}>
//                         <LuTransh2 size={18} />
//                     </button>
//                 )}
